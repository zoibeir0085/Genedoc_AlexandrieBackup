Feature: AlexandrieScenarioFeature
  ...
  Scenario Outline: Scenario Alexandrie1
    ...
    Examples:
      ...
      #| rgauvin@kpmg.fr | aezan75  | 1766186         | Ngk Spark Plugs (France) | aumur CS 50009 92354 LE PLESSIS ROBINSON CEDEX | 9 avenue R | Renaud Laggiard | KPMG AUDIT IS | Paris La D |      
       | rgauvin@kpmg.fr | aezan75  | 1766186         | Ngk Spark Plugs (France) | aumur CS 50009 92354 LE PLESSIS ROBINSON CEDEX | 9 avenue R | Renaud Laggiard | KPMG AUDIT IS | Paris La D |
